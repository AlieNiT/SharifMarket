...
public class DataBase {
    final private ArrayList<Good> goods = new ArrayList<>();
    final private ArrayList<User> users = new ArrayList<>();
    final private ArrayList<Admin> admins = new ArrayList<>();
    final private ArrayList<Order> ordersHistory = new ArrayList<>();
    final private ArrayList<Order> uncheckedOrders = new ArrayList<>();
    private int P = 0;
    private int S = 0;
